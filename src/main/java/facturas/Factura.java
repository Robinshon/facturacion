...
public class Factura extends EntreFechas implements Serializable {
    ...
    public String toString(){
        return "Codigo factura: " + getCodigo() + " | " + "Tarifa: " + tarifa.descripcion() + " | " + "Fecha emision: " + getFecha() + " | " + "Fecha inicio: " + getFechaInicio() + " | " + "Fecha final: " + getFechaFin() + " | " + "Importe: " + getImporte();
    }
